...
print ('''\033[3;91m
          ...
          ║║║├┤ ├┴┐  ╠═╣│ ││││ │ ├┤ ├┬┘
          ╚╩╝└─┘└─┘  ╩ ╩└─┘┘└┘ ┴ └─┘┴└─
                          \033[91m[\033[37mCoded By \033[37mFaizan Mark\033[91m]\033[1;m''')

print ('''\n  I am not responsible for your shit and if you get some error while
 running WebHunter, there are good chances that target isn't responding.\n''')
print ('\033[1;31m--------------------------------------------------------------------------\033[1;m\n')

try:
    target = target.replace('https://', '') #Removes https://
except:
    print ('\033[1;31m[-]\033[1;m -u argument is not supplied. Enter python WebHunter -h for help')
    quit()
